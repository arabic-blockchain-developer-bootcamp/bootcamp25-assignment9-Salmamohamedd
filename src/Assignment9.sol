...
contract Assignment9 is Ownable {
    ...
    constructor () Ownable(msg.sender) {
        // initialize the deployedContracts array
        deployedContracts = new address[](0);        
    }
    ...
    function createContract() external onlyOwner {
        ...
        SimpleContract newContract = new SimpleContract(0); // replace 0 with any arbitrary initial value
